    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
            ...
            <div class="hidden md:flex items-center gap-3">
                <label for="modal-login" class="text-sm font-medium text-gray-700 hover:text-indigo-600 transition-colors px-4 py-2 cursor-pointer">Log in</label>
                <label for="modal-register" class="inline-flex items-center px-5 py-2 rounded-md btn-jtech-primary text-sm font-semibold shadow-sm cursor-pointer">Start Free Trial</label>
            </div>
        ...
        <div id="mobile-menu" class="hidden md:hidden border-t border-gray-200 py-4 space-y-2">
            ...
            <div class="pt-2 border-t border-gray-200 space-y-2">
                <label for="modal-login" class="block px-3 py-2 text-sm font-medium text-gray-700 hover:text-indigo-600 rounded-md transition-colors cursor-pointer">Log in</label>
                <label for="modal-register" class="block px-3 py-2 text-sm font-semibold text-white bg-indigo-600 hover:bg-indigo-700 rounded-md transition-colors text-center cursor-pointer">Start Free Trial</label>
            </div>
        </div>
    </div>
</header>
